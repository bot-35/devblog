...
<ImageBox  src={pushYMLGHA} orientation="horizontal" step="1" legend="Ici je commit le YML sur mon repo avant de sync" alt="Je commit articles-badge.yml avec Source Control de Visual Studio Code"/>

<ImageBox  src={action} orientation="horizontal" step="2" legend="Le workflow s’exécute dans GitHub Actions" alt="Screen de GitHub Actions et du workflow en cours d’exécution."/>

<ImageBox  src={erreur} orientation="horizontal" step="3" legend="Parfois on commet des erreurs 🙈" alt="Screen de GitHub Actions et du workflow en erreur."/>

<ImageBox  src={erreur2} orientation="horizontal" step="3.1" legend="Les détails de l’erreur" alt="Screen de GitHub Actions et du détail de l’erreur du workflow."/>

<ImageBox  src={ok} orientation="horizontal" step="4" legend="Après avoir revu l’indentation, le workflow passe ✨"  alt="Screen de GitHub Actions et du workflow réussi."/>

<ImageBox  src={jobs} orientation="horizontal" step="4.1" legend="Les détails sur le déroulement du workflow" alt="Screen de GitHub Actions et des détails du workflow."/>

<ImageBox  src={badges} orientation="horizontal" step="résultat 1" legend="Les badges ont bien été poussés dans le dépôt 😎" alt="Screen de GitHub et du dépôt contenant maintenant les deux badges."/>

<ImageBox  src={result} orientation="horizontal" step="résultat 2" legend="Le résultat en image" alt="Les badges dans le README."/>
