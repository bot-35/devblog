...
<ImageBox  src={erreur} orientation="horizontal" error legend="Parfois on commet des erreurs 🙈" alt="Screen de GitHub Actions et du workflow en erreur."/>

<ImageBox  src={erreur2} orientation="horizontal" error legend="Les détails de l’erreur" alt="Screen de GitHub Actions et du détail de l’erreur du workflow."/>

<ImageBox  src={ok} orientation="horizontal" step="3" legend="Après avoir revu l’indentation, le workflow passe ✨"  alt="Screen de GitHub Actions et du workflow réussi."/>

<ImageBox  src={jobs} orientation="horizontal" step="3.1" legend="Les détails sur le déroulement du workflow" alt="Screen de GitHub Actions et des détails du workflow."/>

<ImageBox  src={result} orientation="horizontal" result legend="Le résultat en image" alt="Les badges dans le README."/>
