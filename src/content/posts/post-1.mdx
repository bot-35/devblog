...
import pushYMLGHA from '../../img/post/2/push_yml_ghA.png';
import action from '../../img/post/2/action1.png';
import erreur from '../../img/post/2/erreur.png';
import erreur2 from '../../img/post/2/erreur2.png';
import ok from '../../img/post/2/ok.png';
import jobs from '../../img/post/2/jobs.png';
import badges from '../../img/post/2/badges.png';
import result from '../../img/post/2/result.png';
    ...
    En gros ici on va créer un workflow qui s'exécute à chaque fois qu'on push un article dans le repo.
    ...
    À la lecture du script, vous avez probablement une idée déjà assez claire de ce qu'il fait. Mais voici tout de même une explication détaillée de chaque section (vous êtes là pour ça, faudrait pas que je l'oublie 🙈) :
    ...
    Le workflow s'effectue dans GitHub Actions.
    ...
    C’est l’esprit DevOps : automatisation, mise sous version, feedback rapide et mesure. Appliqué à la doc, c’est du DocOps.
